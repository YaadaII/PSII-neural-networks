...
class NeuralNetwork():
    ...
    def train_main(self):
     ...
     with open("C:\\Users\\Morgan\\desktop\\test.txt", 'a') as test:
    ...
    def run_network(self):
        ...
        hidden_state, output = think(array([1, 1, 0]))
        print (output)
invalid_input = True
def start(self) :
    ...
    op = input ("Please input what operation you wish to perform. t for train, r for run, any other key to quit")
    if op == "t":
        print ("Begin training sequence")
        NeuralNetwork.train_main(self)
